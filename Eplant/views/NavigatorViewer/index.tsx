 ...
 */
const getGeneticElementByGeneName = (geneName: string): GeneticElement | null => {
 ...
 */
export const ViewSwitchProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const switchView = async (viewId: string, geneName: string) => {
    ...
    if (!geneticElement) {
      console.log(`GeneticElement not found locally for geneName: ${geneName}. Attempting to load it.`);
    }
